package build_config_pkg;
  ...
  function automatic config_pkg::cva6_cfg_t build_config(config_pkg::cva6_user_cfg_t CVA6Cfg);
    ...
    cfg.ICACHE_USER_LINE_WIDTH = (cfg.ICACHE_LINE_WIDTH/CVA6Cfg.AxiDataWidth) * CVA6Cfg.AxiUserWidth;
    ...
    cfg.DCACHE_USER_LINE_WIDTH = (cfg.DCACHE_LINE_WIDTH/CVA6Cfg.AxiDataWidth) * CVA6Cfg.AxiUserWidth;
    cfg.DCACHE_USER_WIDTH = cfg.CLEN/CVA6Cfg.AxiDataWidth;
