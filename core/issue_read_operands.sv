  ...
  always_comb begin
    ...
    if (CVA6Cfg.SuperscalarEn) begin
      if (issue_instr_i[1].fu == CTRL_FLOW) begin
        pc_n                  = cva6_cheri_pkg::set_cap_reg_address(pcc_q, issue_instr_i[1].pc, cva6_cheri_pkg::get_cap_reg_meta_data(pcc_q))
    ...
    if (issue_instr_i[0].fu == CTRL_FLOW) begin
      pc_n                  = cva6_cheri_pkg::set_cap_reg_address(pcc_q, issue_instr_i[0].pc, cva6_cheri_pkg::get_cap_reg_meta_data(pcc_q))
