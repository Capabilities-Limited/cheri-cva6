...
if (CVA6Cfg.CheriPresent) begin : gen_cheri_pcc_checks
  ...
  always_comb begin : forwarding_operand_select
    ...
    if (CVA6Cfg.CheriPresent) begin
      ...
      else if (resolved_branch_i.valid && (resolved_branch_i.target_address != cva6_cheri_pkg::set_cap_reg_address(pcc, resolved_branch_i.target_address[CVA6Cfg.XLEN-1:0], pcc_meta))) begin
