...
#(
  ...
  always_ff @(posedge clk_i) begin
    for (int i = 0; i < CVA6Cfg.NrCommitPorts; i++) begin
      ...
      rvfi_instr_o[i].mem_wmask <= (((mem_q[commit_pointer[i]].instr & 32'hF800703F) == 32'h1800402F) && wdata[i] == 1) ? '0 : mem_q[commit_pointer[i]].lsu_wmask >> mem_q[commit_pointer[i]].lsu_addr[3:0];
