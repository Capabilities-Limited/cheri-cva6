...
#(
    ...
    // DII ID of requested instruction in block - CACHE
      ...
      case (address_i[2:1])
        2'b00: begin
          ...
          if (unaligned_q) begin
            ...
            if (instr_is_compressed[1]) begin
              ...
              if (instr_is_compressed[2]) begin
                if (instr_is_compressed[3]) begin
                  ...
                  unaligned_instr_d   = instr_o[3][15:0];
            ...
            addr_o[0]  = address_i;
            if (CVA6Cfg.RVFI_DII) dii_id_o[0] = dii_id_i;
          ...
          if (instr_is_compressed[0]) begin
            ...
            if (instr_is_compressed[1]) begin
              if (instr_is_compressed[2]) begin
                ...
                unaligned_d         = 1'b1;
                unaligned_instr_d   = instr_o[2][15:0];
        ...
        2'b10: begin
          ...
          if (instr_is_compressed[0]) begin
            if (instr_is_compressed[1]) begin
              ...
              unaligned_d         = 1'b1;
              unaligned_instr_d   = instr_o[1][15:0];
        ...
        2'b11: begin
          ...
          if (instr_is_compressed[0]) begin
            ...
            unaligned_d         = 1'b1;
            unaligned_instr_d   = instr_o[0][15:0];
