    ...
    always_comb begin
        ...
        unique case (fu_data_i.operation)
            ...
            ariane_pkg::GCPERM: begin
                clu_result = set_cap_reg_addr(REG_NULL_CAP, {{CVA6Cfg.XLEN-$bits(cap_report_perms_t){1'b0}},
            ...
            ariane_pkg::CRAM: begin
                ...
                res_set_bounds = set_cap_reg_bounds(operand_a, operand_a_address, {1'b0,operand_b_address});
