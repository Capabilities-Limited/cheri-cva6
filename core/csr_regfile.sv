...
#(
  ...
  always_comb begin : csr_op_logic
    ...
    csr_we    = 1'b1;
    csr_write_cap = (CVA6Cfg.CheriPresent && !commit_instr_i[0].int_mode && csr_op_i == CSR_WRITE && !csr_op_is_imm_i) ? 1'b1 : 1'b0;;
    csr_read  = 1'b1;
  ...
  always_comb begin
    ...
    unique case (conv_csr_addr.address)
      riscv::CSR_MIP:
      csr_rdata_tmp = csr_rdata_tmp | ({{CVA6Cfg.XLEN - 1{1'b0}}, irq_i[1]} << riscv::IRQ_S_EXT);
  ...
  always_ff @(posedge clk_i or negedge rst_ni) begin
    if (~rst_ni) begin
      ...
      if (CVA6Cfg.DebugEn) begin
        ...
        dpc_q            <= cva6_cheri_pkg::REG_ROOT_CAP;
